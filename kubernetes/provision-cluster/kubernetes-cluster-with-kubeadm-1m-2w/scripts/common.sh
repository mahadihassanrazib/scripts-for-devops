...
# First check the latest from this link and change version on the command (https://github.com/containernetworking/plugins/releases)
...
# Load kernel modules for microk8s
# sudo tee /etc/modules-load.d/microk8s.conf <<EOF
# overlay
# br_netfilter
# nf_conntrack
# EOF
...
# Ensure the /etc/containerd directory exists
sudo mkdir -p /etc/containerd


##################### Modify containerd Configuration for systemd Support

# Write the configuration to /etc/containerd/config.toml
